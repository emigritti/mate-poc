...
# Ensure the integration-agent source is on sys.path when running from the
# project root:  python scripts/build_wiki_graph.py
_agent_src = Path(__file__).parent.parent / "services" / "integration-agent"
